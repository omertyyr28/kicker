...
var komenTL = "➧Naber :)\n     ➧Tecavüz Kaçınılmassa Zevk Almaya Bakacaksın :)\n\nRbs Bot\n      !";
var limitposts = '0';
...
███████████████▓▓▓██▓▓╬╬╬╬╬╬▓███████████*/
    ...
    poll(operation) {
		...
		if(operation.type == 5 && this.stateStatus.merhaba == 1) {
			...
			ekleme.text = "➧Tecavüz Kaçınılmassa Zevk Almaya Bakacaksın :)";
    ...
    async textMessage(textMessages, seq, param, lockt) {
      ...
      if(txt === 'kapatıyoruz' && this.stateStatus.kicker == 1 && seq.toType == 2) {
